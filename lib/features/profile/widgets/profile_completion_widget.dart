...
class ProfileCompletionWidget extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                if (!completion.isCompleted &&
                    completion.missingSteps.isNotEmpty) ...[
                  const SizedBox(height: 16),
  ...
  Widget _buildProgressIndicator(
      BuildContext context, ProfileCompletion completion) {
  ...
  Widget _buildCompletionStatus(
    ...
    final promptCount =
        profileProvider.prompts.where((p) => p.isNotEmpty).length;
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        _buildStrengthRow(
            context, 'Photos', photoCount, 6, completion.hasPhotos),
        _buildStrengthRow(
            context, 'Prompts', promptCount, 3, completion.hasPrompts),
        _buildStrengthRow(context, 'Questionnaire', questionnaireCount, 10,
            completion.hasPersonalityAnswers),
        _buildStatusRow(context, 'Informations de base',
            completion.hasRequiredProfileFields),
      ],
    );
  }
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                    color:
                        completed ? AppColors.textDark : AppColors.textTertiary,
                  ),
            ),
          ),
        ],
