                        ...
                        child: ElevatedButton.icon(
                                  ...
                                  try {
                                    ...
                                    if (authProvider.isAuthenticated &&
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                              'Erreur de connexion Google: ${authProvider.error}'),
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            side: const BorderSide(
                                color: AppColors.dividerLight, width: 1.5),
                            padding: const EdgeInsets.symmetric(vertical: 18),
                            elevation: 0,
                          ),
                        ),
                                  ...
                                  try {
                                    ...
                                    if (authProvider.isAuthenticated &&
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          ...
                                          backgroundColor: AppColors
                                              .textDark, // Distinct color for Apple
                                          behavior: SnackBarBehavior.floating,
                                        ),
                                      );
                                      // Let the app routing handle where to go based on completion status
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                              'Erreur de connexion Apple: ${authProvider.error}'),
                                          backgroundColor: AppColors.errorRed,
                                          behavior: SnackBarBehavior.floating,
                                          shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        AppColors.accentCream.withValues(alpha: 0.6),
                        AppColors.accentCream.withValues(alpha: 0.3),
                      ],
                    ),
